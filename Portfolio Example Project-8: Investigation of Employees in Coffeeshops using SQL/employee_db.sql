...
-- Insert the first two rows into employees table
...
-- Insert the first row into the shops table
INSERT INTO shops VALUES (1, 'Common Grounds', NULL);
-- Set the coffeshop_id for the first two rows of the employees table to 1
UPDATE employees
SET coffeeshop_id = 1
WHERE employee_id IN (501559, 144108);

-- Insert Los Angles into the locations table
INSERT INTO locations VALUES (1, 'Los Angles', 'United States');
-- Set the city_id in the shops table for coffeeshop_id = 1 to 1
UPDATE shops
SET city_id = 1
WHERE coffeeshop_id = 1;

-- Insert the first two rows into the suppliers table
